...
public class InfoCommand implements Command {
    ...
    private final String info = "Tennis_matchmaking_bot FAQ" +
           " \n" +
            ...
            "Формат игры: серия партий до двух побед, каждая из которых до 11 или до 21 очков, на выбор игроков\n" +
            ...
            " \n"+
            " \n"+
            "Сервис не имеет прямого отношения к администрации Fitness One, создан одним из посетителей клуба на добровольной основе :) \n"+
